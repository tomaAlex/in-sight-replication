...
var TransformControls = function(camera, domElement) {
  ...
  var rotationStart = new THREE.Euler();
  ...
  this.attach = function(object) {
    this.object = object;
    if(this.object.allowedAxis)
    {
      if (this.object.allowedAxis["X"]) this.showX = true;
      else this.showX = false;
      if (this.object.allowedAxis["Y"]) this.showY = true;
      else this.showY = false;
      if (this.object.allowedAxis["Z"]) this.showZ = true;
      else this.showZ = false;
    }
    else
    {
  ...
  this.pointerDown = function(pointer) {
    ...
    if (
      ...
      if (planeIntersect) {
        ...
        rotationStart = new THREE.Euler(this.object.rotation.x, this.object.rotation.y, this.object.rotation.z, this.object.rotation.order);
  ...
  this.pointerMove = function(pointer) {
    ...
    if (mode === "translate") {
      ...
      if(axis == "X")
        rotationAngle = (rotationStart.x + rotationAngle).clamp(object.rotMin - degToRad(object.rotOffset), object.rotMax - degToRad(object.rotOffset)) - rotationStart.x;
      if(axis == "Y")
        rotationAngle = (rotationStart.y + rotationAngle).clamp(object.rotMin - degToRad(object.rotOffset), object.rotMax - degToRad(object.rotOffset)) - rotationStart.y;
      if(axis == "Z")
        rotationAngle = (rotationStart.z + rotationAngle).clamp(object.rotMin - degToRad(object.rotOffset), object.rotMax - degToRad(object.rotOffset)) - rotationStart.z;
